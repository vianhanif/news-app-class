class AgendasController < ApplicationController
  ...
  # GET /agendas.json
  def index
    @agendas = Agenda.all.paginate(page: params[:page], per_page: 10)
    content_for :title, "Agendas"
  end
  ...
  private
    ...
    def agenda_params
      params.require(:agenda).permit(:title, :organizer, :image, :location, :date, :start, :end, :description, :price, :slug)
    end
end
